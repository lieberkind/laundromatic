...
<body>
	...
	<form action="http://93.163.45.78/Bestil.asp?Mode=Bestil" method="POST">
		<input type="hidden" name="Dato" value="20150131">
		<input type="hidden" name="Tur" value="4">
		<input type="hidden" name="Gruppe" value="1">
		<input type="hidden" name="Lejlighed" value="71">
		<input type="hidden" name="Beboer" value="2">
		<input type="hidden" name="KortNr" value="1">
		<input type="hidden" name="RetMode" value="">
